...
class market:
    ...
    def market_bid(self):
        ...
        # df frame
        use_cols = ['수집기간','키워드','입찰공고번호','입찰공고일시','참조번호','입찰공고명','공고기관명','입찰방식명','계약체결방법명','개찰일시',
                   '배정예산금액','추정가격','용역구분명','공동수급구성방식명','낙찰방법명','입찰공고상세URL','공고규격서URL1','공고규격서URL2',
                   '공고규격서URL3','공고규격서URL4','공고규격서URL5','공고규격파일명1','공고규격파일명2','공고규격파일명3','공고규격파일명4',
                   '공고규격파일명5']
        df_market3 = df_market2[use_cols]
